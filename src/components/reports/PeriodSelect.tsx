...
export function PeriodSelect({ year, month, onYearChange, onMonthChange }: PeriodSelectProps) {
  ...
  return (
    <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 sm:flex">
      <Select aria-label="Month" value={month} onChange={(e) => onMonthChange(Number(e.target.value))} className="min-w-0">
      ...
      <Select aria-label="Year" value={year} onChange={(e) => onYearChange(Number(e.target.value))}>
